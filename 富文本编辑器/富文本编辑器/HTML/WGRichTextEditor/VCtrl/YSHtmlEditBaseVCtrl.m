...
@interface YSHtmlEditBaseVCtrl ()<UITextViewDelegate,UIWebViewDelegate,KWEditorBarDelegate,KWFontStyleBarDelegate,HXAlbumListViewControllerDelegate,UIAlertViewDelegate>
...
- (void)viewDidLoad {
    ...
    [[NSNotificationCenter defaultCenter]addObserver:self selector:@selector(keyBoardDidShowFrame:) name:UIKeyboardDidShowNotification object:nil];
...
//        [YSUserDefaultsModel saveObject:htmlStr Key:CreateOrEditArticleContent];
//    });
...
- (void)viewDidLayoutSubviews {
    ...
    self.webView.frame = CGRectMake(0,SCREEN_Nav_H, SCREEN_WIDTH,SCREEN_HEIGHT - SCREEN_Nav_H - SCREEN_B_0);
}
...
//    [webView setupContent:@"<p>添加测试呢</p><br><img src=\"https://ss0.baidu.com/6ONWsjip0QIZ8tyhnq/it/u=4278445236,4070967445&amp;fm=173&amp;app=25&amp;f=JPEG?w=218&amp;h=146&amp;s=B1145A915E28110D18B9A940030080B2\"><br><br><p>让人</p>"];
    ...
    ctx[@"contentUpdateCallback"] = ^(JSValue *msg) {
        [weakSelf.webView autoScrollTop:[weakSelf.webView getCaretYPosition] - [weakSelf editKeyboardHeight]];
    };
...
- (void)keyBoardDidShowFrame:(NSNotification*)notification{
     ...
     */
    [self.webView autoScrollTop:[self.webView getCaretYPosition] - [self editKeyboardHeight]];
}
